...
from app.schemas.erp import CuentaPorPagarRespuesta, AbonoCrear, AbonoRespuesta
from app.services import cxp_service
from app import models

router = APIRouter(prefix="/cuentas-por-pagar", tags=["Cuentas por Pagar"])
abonos_router = APIRouter(prefix="/cuentas-por-pagar/abonos", tags=["Abonos"])
